...
import { clearAttribute,CartSwitch, quantity, getProducts,setCount,getItemToCart,closeDisplay,fetchCategories,BannerDisplay,getCartItem } from '../../actions/index';
...
function mapStateToProps(state) {
    return {
        ...
        cart: state.cart,
        flick:state.flick,
        name:state.getAllProducts.name,
