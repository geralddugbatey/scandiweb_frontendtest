...
import { clearAttribute,CartSwitch, quantity, getTechProducts,setCount,getItemToCart,closeDisplay,fetchCategories,BannerDisplay,getCartItem } from '../../actions/index';
...
function mapStateToProps(state) {
    return {
        products:state.getTechProducts.products,
        price_index:state.price_index,
        cart: state.cart,
        flick:state.flick,
        name:state.getTechProducts.name,
...
function mapDispatchToProps(dispatch){
    ...
    return{
        getProducts:()=>dispatch(getTechProducts()),
